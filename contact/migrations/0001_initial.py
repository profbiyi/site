# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-17 16:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=100, validators=[django.core.validators.MinLengthValidator(5), django.core.validators.RegexValidator('[aA-zZ]+(?:[aA-zZ]+) [aA-zZ]+\\Z', code='invalid', message='Enter a valid name (first & last, letters only).')], verbose_name='Full Name')),
